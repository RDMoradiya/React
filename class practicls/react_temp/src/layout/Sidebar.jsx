    ...
    <div
      ...
      <div className="w-100 text-center pt-3 pb-3 d-flex align-items-center justify-content-center">
        <a href="/" className="text-white">
          <i className="fa-solid fa-shop text-end" style={{ fontSize: "25px" }}></i>
        </a>
      ...
      <ul className="list-group">
        {Links.map((item) => {
          ...
          return (
            <li key={id} className="mainside m-0 p-0 border-0 text-white" style={{ background: "rgb(8, 61, 123)" }}>
              <NavLink to={link} className="sides p-2 ps-3 w-100 text-decoration-none" onClick={() => dispatch(closeMenu())}>
                <span>{title}</span>
              </NavLink>
            </li>
          );
