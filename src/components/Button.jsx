    ...
    <>
      ...
      <div className="card mb-5 w-50 m-auto">
        ...
        <div className="card-body">
          <button
            ...
            className={`btn ${islogin ? "btn-primary" : "btn-danger"}`}
          >
      ...
      <div className="card mb-5 w-50 m-auto " id="theme">
        <div className="card-header d-flex justify-content-between">
          ...
          <button
            className={`btn ${isDarkMode ? "btn-secondary" : "btn-dark"}`}
        ...
        <div className="card-body">
          ...
          <button
            className={`btn ${isimage ? "btn-success" : "btn-primary"}`}
            onClick={() => setIsImage(!isimage)}
          >
            {isimage ? "Hide Image" : "Show Image"}
          </button>
          ...
          {isimage ? (
            <img
              src="https://img.freepik.com/free-vector/cute-panda-with-bamboo-cartoon-vector-icon-illustration-animal-nature-icon-concept-isolated-vector_138676-4386.jpg?w=2000"
              alt="panda"
              className="w-50 mt-2"
            />
          ) : null}
